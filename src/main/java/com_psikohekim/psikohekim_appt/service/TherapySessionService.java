...
public interface TherapySessionService {
    ...
    /**
     * Danışanın görüşme defteri - tamamlanmış görüşmelerin notları (hasta hikayesi)
     */
    List<SessionResponse> getPatientJournal(Long patientId, Long therapistId, boolean isAdmin);
