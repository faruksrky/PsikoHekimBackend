...
public class TherapistPatientServiceImpl implements TherapistPatientService {
    ...
    private PatientSummaryDto convertToPatientSummary(TherapistPatient assignment) {
        ...
        return PatientSummaryDto.builder()
                ...
                .patientCountry(patient.getPatientCountry())
                .reasonForApplication(patient.getReasonForApplication())
                .sessionFeePerSession(assignment.getTherapist() != null ? assignment.getTherapist().getTherapistAppointmentFee() : null)
