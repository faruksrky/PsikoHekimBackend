...
echo "=== 0. sites-enabled'dan .bak dosyalarını kaldır ==="
...
for f in /etc/nginx/sites-available/auth.iyihislerapp.com; do
...
for f in /etc/nginx/sites-available/api.iyihislerapp.com; do
